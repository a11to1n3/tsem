...
from ..utils.model_helpers import View, Squeeze, SwapLastDims, ExtractLastCell
...
class TSEM(nn.Module):
    def __init__(self, window_size, time_length, feature_length, n_classes):
        ...
        assert window_size <= time_length, 'Window size must be smaller than time dimension.'
